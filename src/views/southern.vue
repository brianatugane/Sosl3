  ...
  <section class="bg-white min-h-screen">
    ...
    >
      <div class="bg-black/60 p-10 rounded-3xl text-center max-w-3xl">
        <h1 class="text-7xl font-extrabold text-white mb-4">
          {{ $i18n.t('provinces.southern.title') }}
        </h1>

        <p class="text-xl text-gray-200">
          {{ $i18n.t('provinces.southern.description') }}
        </p>

        <button class="mt-6 bg-green-600 text-white px-8 py-4 rounded-xl hover:bg-green-700">
          {{ $i18n.t('provinces.southern.exploreBtn') }}
        </button>
      </div>
    </div>
    ...
    <div class="py-20 px-8">
      ...
      <div class="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-3xl shadow-xl overflow-hidden">
          ...
          <div class="p-6">
            <h3 class="text-2xl font-bold text-green-700">
              {{ $i18n.t('provinces.southern.attraction1') }}
            </h3>
            <p class="text-gray-600 mt-3">
              {{ $i18n.t('provinces.southern.attraction1Desc') }}
            </p>
          </div>
        </div>
        ...
        <div class="bg-white rounded-3xl shadow-xl overflow-hidden">
          <img
            src="/src/assets/heritage.png"
            class="w-full h-60 object-cover"
          >
          <div class="p-6">
            <h3 class="text-2xl font-bold text-green-700">
              {{ $i18n.t('provinces.southern.attraction2') }}
            </h3>
            <p class="text-gray-600 mt-3">
              {{ $i18n.t('provinces.southern.attraction2Desc') }}
            </p>
          </div>
        </div>
        ...
        <div class="bg-white rounded-3xl shadow-xl overflow-hidden">
          <img
            src="/src/assets/kibeho.png"
            class="w-full h-60 object-cover"
          >
          <div class="p-6">
            <h3 class="text-2xl font-bold text-green-700">
              {{ $i18n.t('provinces.southern.attraction3') }}
            </h3>
            <p class="text-gray-600 mt-3">
              {{ $i18n.t('provinces.southern.attraction3Desc') }}
            </p>
          </div>
        </div>
    ...
    <div class="bg-green-50 py-20 px-8">
      ...
      <div class="max-w-6xl mx-auto">
        ...
        <h2 class="text-5xl font-bold text-center text-green-700 mb-12">
          {{ $i18n.t('provinces.southern.whyVisitTitle') }}
        </h2>

        <div class="grid md:grid-cols-3 gap-8">

          <div class="bg-white p-8 rounded-2xl shadow">
            <h3 class="text-2xl font-bold mb-3">🌍 {{ $i18n.t('provinces.southern.card1') }}</h3>
            <p class="text-gray-600">
              {{ $i18n.t('provinces.southern.card1Desc') }}
            </p>
          </div>
    ...
    <div class="bg-green-700 text-white text-center py-20">
      ...
      <h2 class="text-5xl font-bold mb-5">
        {{ $i18n.t('provinces.southern.ctaTitle') }}
      </h2>
      ...
      <button class="bg-white text-green-700 px-10 py-4 rounded-xl font-bold">
        {{ $i18n.t('provinces.southern.ctaBtn') }}
      </button>
